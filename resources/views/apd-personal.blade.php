...
<head>
  ...
  <link rel="shortcut icon" href="{{ URL::asset('assets/thumbnail.jpg') }}">
...
<body class="hold-transition skin-green sidebar-mini">
  <div class="wrapper">
    ...
    @include('karyawan.leftside-apd-personal')
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="#">Pesan APD</a></li>
          <li class="active">@foreach($apd as $a)
          @switch ($a->id_kategori) 
            @case(1)
              Kacamata Pengaman
              @break
