        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="pakaian1.html"><i class="fa fa-circle-o"></i> Pakaian Pengaman</a></li>
              <li><a href="tangan1.html"><i class="fa fa-circle-o"></i> Sarung Tangan</a></li>
              <li><a href="wajah1.html"><i class="fa fa-circle-o"></i> Pelindung Wajah</a></li>
              <li><a href="lainnya1.html"><i class="fa fa-circle-o"></i> Lainnya</a></li>
            </ul>
          </li>
